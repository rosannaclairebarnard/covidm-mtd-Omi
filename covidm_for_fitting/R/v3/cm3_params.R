...
cm_check_parameters = function(parameters)
{
    ...
    for (i in 1:length(parameters$pop))
    {
        ...
        reqp(i, "p_boost_va2",  "is.numeric(p_boost_va2) & length(p_boost_va2) == length(size) & all(p_boost_va2 >= 0) & all(p_boost_va2 <= 1)");
        reqp(i, "p_boost_va3",  "is.numeric(p_boost_va3) & length(p_boost_va3) == length(size) & all(p_boost_va3 >= 0) & all(p_boost_va3 <= 1)");
        ...
        reqp(i, "p_boost_vb2",  "is.numeric(p_boost_vb2) & length(p_boost_vb2) == length(size) & all(p_boost_vb2 >= 0) & all(p_boost_vb2 <= 1)");
        reqp(i, "p_boost_vb3",  "is.numeric(p_boost_vb3) & length(p_boost_vb3) == length(size) & all(p_boost_vb3 >= 0) & all(p_boost_vb3 <= 1)");
...
cm_base_pop_SEI3R = function(n_groups)
{
    ...
    list(
        ...
        p_boost_va2 = rep(1, n_groups),
        p_boost_va3 = rep(1, n_groups),
        vb1 = rep(0, n_groups),
        wvb1 = rep(0, n_groups),
        ...
        p_boost_vb2 = rep(1, n_groups),
        p_boost_vb3 = rep(1, n_groups),
        A = rep(0, n_groups),
        B = rep(0, n_groups),
        D = rep(0, n_groups),
        season_A = 0,
    ...
    dist_seed_ages = NULL, observer = NULL, schedule = NULL)
{
    ...
    pop = assign_g(pop, "p_boost_va2", p_boost_va2, n_groups);
    pop = assign_g(pop, "p_boost_va3", p_boost_va3, n_groups);
    ...
    pop = assign_g(pop, "p_boost_vb2", p_boost_vb2, n_groups);
    pop = assign_g(pop, "p_boost_vb3", p_boost_vb3, n_groups);
    ...
    dist_seed_ages = NULL, observer = NULL, schedule = NULL)
{
    ...
    for (i in seq_along(dem_locations))
    {
        pop[[i]] = cm_build_pop_SEI3R(dem_locations[i], mat_locations[i],
            ...
            p_boost_va2 = p_boost_va2,
            p_boost_va3 = p_boost_va3,
            vb1 = vb1, wvb1 = wvb1, 
