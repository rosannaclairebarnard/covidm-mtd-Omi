...
Reporter::Reporter(Parameters& P)
 : t0(P.time0),
   ...
   col_names({ "S", "E", "Ip", "Is", "Ia", "R", "E2", "Ip2", "Is2", "Ia2", "R2",
              "E3", "Ip3", "Is3", "Ia3", "R3", "Va1", "Va2", "Va3", "Vb1", "Vb2", "Vb3",
              "foi", "foi2", "foi3", "deaths", "hosp_adm", "hosp_bed", "icu_adm", "icu_bed",
              "deaths_V1", "deaths_V2", "deaths_V3", "hosp_adm_V1", "hosp_adm_V2", "hosp_adm_V3"})
{
