...
void Population::Tick(Parameters& P, Randomizer& Rand, double t, vector<double>& infec, vector<double>& infec2, vector<double>& infec3, Reporter& rep)
{
    ...
    for (unsigned int a = 0; a < lambda.size(); ++a)
    {
        ...
        S[a]   += nVa2_S;
        Vb2[a].Add(P, Rand, nVb1_Vb2, P.pop[p].dVb2);
        S[a]   += nVb2_S;
        Va3[a] += nVa2_Va3;
        Va3[a] -= nVa3_S;
        S[a]   += nVa3_S;
        ...
        double nR_E123   = binomial(R[a], 1.0 - exp(-(foi_r + foi2_r + foi3_r) * P.time_step));
        double nR_E      = binomial(nR_E123, foi_r + foi2_r + foi3_r > 0 ? foi_r / (foi_r + foi2_r + foi3_r) : 0);
        double nR_E2E3   = nR_E123 - nR_E;
        double nR_E2     = binomial(nR_E2E3, foi2_r + foi3_r > 0 ? foi2_r / (foi2_r + foi3_r) : 0);
        double nR_E3     = nR_E2E3 - nR_E2;

        double nR2_E123  = binomial(R2[a], 1.0 - exp(-(foi_r2 + foi2_r2 + foi3_r2) * P.time_step));
        double nR2_E     = binomial(nR2_E123, foi_r2 + foi2_r2 + foi3_r2 > 0 ? foi_r2 / (foi_r2 + foi2_r2 + foi3_r2) : 0);
        double nR2_E2E3  = nR2_E123 - nR2_E;
        double nR2_E2    = binomial(nR2_E2E3, foi2_r2 + foi3_r2 > 0 ? foi2_r2 / (foi2_r2 + foi3_r2) : 0);
        double nR2_E3    = nR2_E2E3 - nR2_E2;

        double nR3_E123  = binomial(R3[a], 1.0 - exp(-(foi_r3 + foi2_r3 + foi3_r3) * P.time_step));
        double nR3_E     = binomial(nR3_E123, foi_r3 + foi2_r3 + foi3_r3 > 0 ? foi_r3 / (foi_r3 + foi2_r3 + foi3_r3) : 0);
        double nR3_E2E3  = nR3_E123 - nR3_E;
        double nR3_E2    = binomial(nR3_E2E3, foi2_r3 + foi3_r3 > 0 ? foi2_r3 / (foi2_r3 + foi3_r3) : 0);
        double nR3_E3    = nR3_E2E3 - nR3_E2;
        ...
        double nVa1_E     = binomial(nVa1_REL - nVa1_R, (1 - P.pop[p].ed_va1i[a]) / (1 - P.pop[p].et_va1i[a]));
        double nVa1_L     = nVa1_REL - nVa1_R - nVa1_E;
        double nVa1_R2    = binomial(nVa1_REL2, P.pop[p].et_va1i2[a]);
        double nVa1_E2    = binomial(nVa1_REL2 - nVa1_R2, (1 - P.pop[p].ed_va1i2[a]) / (1 - P.pop[p].et_va1i2[a]));
        double nVa1_L2    = nVa1_REL2 - nVa1_R2 - nVa1_E2;
        double nVa1_R3    = binomial(nVa1_REL3, P.pop[p].et_va1i3[a]);
        double nVa1_E3    = binomial(nVa1_REL3 - nVa1_R3, (1 - P.pop[p].ed_va1i3[a]) / (1 - P.pop[p].et_va1i3[a]));
        ...
        double nVa2_E     = binomial(nVa2_REL - nVa2_R, (1 - P.pop[p].ed_va2i[a]) / (1 - P.pop[p].et_va2i[a]));
        double nVa2_L     = nVa2_REL - nVa2_R - nVa2_E;
        double nVa2_R2    = binomial(nVa2_REL2, P.pop[p].et_va2i2[a]);
        double nVa2_E2    = binomial(nVa2_REL2 - nVa2_R2, (1 - P.pop[p].ed_va2i2[a]) / (1 - P.pop[p].et_va2i2[a]));
        double nVa2_L2    = nVa2_REL2 - nVa2_R2 - nVa2_E2;
        double nVa2_R3    = binomial(nVa2_REL3, P.pop[p].et_va2i3[a]);
        double nVa2_E3    = binomial(nVa2_REL3 - nVa2_R3, (1 - P.pop[p].ed_va2i3[a]) / (1 - P.pop[p].et_va2i3[a]));
        ...
        double nVa3_E     = binomial(nVa3_REL - nVa3_R, (1 - P.pop[p].ed_va3i[a]) / (1 - P.pop[p].et_va3i[a]));
        double nVa3_L     = nVa3_REL - nVa3_R - nVa3_E;
        double nVa3_R2    = binomial(nVa3_REL2, P.pop[p].et_va3i2[a]);
        double nVa3_E2    = binomial(nVa3_REL2 - nVa3_R2, (1 - P.pop[p].ed_va3i2[a]) / (1 - P.pop[p].et_va3i2[a]));
        double nVa3_L2    = nVa3_REL2 - nVa3_R2 - nVa3_E2;
        double nVa3_R3    = binomial(nVa3_REL3, P.pop[p].et_va3i3[a]);
        double nVa3_E3    = binomial(nVa3_REL3 - nVa3_R3, (1 - P.pop[p].ed_va3i3[a]) / (1 - P.pop[p].et_va3i3[a]));
        ...
        double nVb1_E     = binomial(nVb1_REL - nVb1_R, (1 - P.pop[p].ed_vb1i[a]) / (1 - P.pop[p].et_vb1i[a]));
        double nVb1_L     = nVb1_REL - nVb1_R - nVb1_E;
        double nVb1_R2    = binomial(nVb1_REL2, P.pop[p].et_vb1i2[a]);
        double nVb1_E2    = binomial(nVb1_REL2 - nVb1_R2, (1 - P.pop[p].ed_vb1i2[a]) / (1 - P.pop[p].et_vb1i2[a]));
        double nVb1_L2    = nVb1_REL2 - nVb1_R2 - nVb1_E2;
        double nVb1_R3    = binomial(nVb1_REL3, P.pop[p].et_vb1i3[a]);
        double nVb1_E3    = binomial(nVb1_REL3 - nVb1_R3, (1 - P.pop[p].ed_vb1i3[a]) / (1 - P.pop[p].et_vb1i3[a]));
        ...
        double nVb2_E     = binomial(nVb2_REL - nVb2_R, (1 - P.pop[p].ed_vb2i[a]) / (1 - P.pop[p].et_vb2i[a]));
        double nVb2_L     = nVb2_REL - nVb2_R - nVb2_E;
        double nVb2_R2    = binomial(nVb2_REL2, P.pop[p].et_vb2i2[a]);
        double nVb2_E2    = binomial(nVb2_REL2 - nVb2_R2, (1 - P.pop[p].ed_vb2i2[a]) / (1 - P.pop[p].et_vb2i2[a]));
        double nVb2_L2    = nVb2_REL2 - nVb2_R2 - nVb2_E2;
        double nVb2_R3    = binomial(nVb2_REL3, P.pop[p].et_vb2i3[a]);
        double nVb2_E3    = binomial(nVb2_REL3 - nVb2_R3, (1 - P.pop[p].ed_vb2i3[a]) / (1 - P.pop[p].et_vb2i3[a]));
        ...
        double nVb3_E     = binomial(nVb3_REL - nVb3_R, (1 - P.pop[p].ed_vb3i[a]) / (1 - P.pop[p].et_vb3i[a]));
        double nVb3_L     = nVb3_REL - nVb3_R - nVb3_E;
        double nVb3_R2    = binomial(nVb3_REL2, P.pop[p].et_vb3i2[a]);
        double nVb3_E2    = binomial(nVb3_REL2 - nVb3_R2, (1 - P.pop[p].ed_vb3i2[a]) / (1 - P.pop[p].et_vb3i2[a]));
        double nVb3_L2    = nVb3_REL2 - nVb3_R2 - nVb3_E2;
        double nVb3_R3    = binomial(nVb3_REL3, P.pop[p].et_vb3i3[a]);
        double nVb3_E3    = binomial(nVb3_REL3 - nVb3_R3, (1 - P.pop[p].ed_vb3i3[a]) / (1 - P.pop[p].et_vb3i3[a]));
        ...
        double fatal    = binomial(nS_E,    P.pop[p].ifr1[a]) +
                          binomial(nVa1_E,  P.pop[p].ifr1[a] * (1. - P.pop[p].em_va1d[a])) +
                          binomial(nVa2_E,  P.pop[p].ifr1[a] * (1  - P.pop[p].em_va2d[a])) +
                          binomial(nVa3_E,  P.pop[p].ifr1[a] * (1  - P.pop[p].em_va3d[a])) +
                          binomial(nVb1_E,  P.pop[p].ifr1[a] * (1  - P.pop[p].em_vb1d[a])) +
                          binomial(nVb2_E,  P.pop[p].ifr1[a] * (1  - P.pop[p].em_vb2d[a])) +
                          binomial(nVb3_E,  P.pop[p].ifr1[a] * (1  - P.pop[p].em_vb3d[a])) +
                          binomial(nS_E2,   P.pop[p].ifr2[a]) +
                          binomial(nVa1_E2, P.pop[p].ifr2[a] * (1. - P.pop[p].em_va1d2[a])) +
                          binomial(nVa2_E2, P.pop[p].ifr2[a] * (1  - P.pop[p].em_va2d2[a])) +
                          binomial(nVa3_E2, P.pop[p].ifr2[a] * (1  - P.pop[p].em_va3d2[a])) +
                          binomial(nVb1_E2, P.pop[p].ifr2[a] * (1  - P.pop[p].em_vb1d2[a])) +
                          binomial(nVb2_E2, P.pop[p].ifr2[a] * (1  - P.pop[p].em_vb2d2[a])) +
                          binomial(nVb3_E2, P.pop[p].ifr2[a] * (1  - P.pop[p].em_vb3d2[a])) +
                          binomial(nS_E3,   P.pop[p].ifr3[a]) +
                          binomial(nVa1_E3, P.pop[p].ifr3[a] * (1. - P.pop[p].em_va1d3[a])) +
                          binomial(nVa2_E3, P.pop[p].ifr3[a] * (1  - P.pop[p].em_va2d3[a])) +
                          binomial(nVa3_E3, P.pop[p].ifr3[a] * (1  - P.pop[p].em_va3d3[a])) +
                          binomial(nVb1_E3, P.pop[p].ifr3[a] * (1  - P.pop[p].em_vb1d3[a])) +
                          binomial(nVb2_E3, P.pop[p].ifr3[a] * (1  - P.pop[p].em_vb2d3[a])) +
                          binomial(nVb3_E3, P.pop[p].ifr3[a] * (1  - P.pop[p].em_vb3d3[a]));
        double severe   = binomial(nS_E,    P.pop[p].ihr1[a]) +
                          binomial(nVa1_E,  P.pop[p].ihr1[a] * (1. - P.pop[p].eh_va1d[a])) +
                          binomial(nVa2_E,  P.pop[p].ihr1[a] * (1  - P.pop[p].eh_va2d[a])) +
                          binomial(nVa3_E,  P.pop[p].ihr1[a] * (1  - P.pop[p].eh_va3d[a])) +
                          binomial(nVb1_E,  P.pop[p].ihr1[a] * (1  - P.pop[p].eh_vb1d[a])) +
                          binomial(nVb2_E,  P.pop[p].ihr1[a] * (1  - P.pop[p].eh_vb2d[a])) +
                          binomial(nVb3_E,  P.pop[p].ihr1[a] * (1  - P.pop[p].eh_vb3d[a])) +
                          binomial(nS_E2,   P.pop[p].ihr2[a]) +
                          binomial(nVa1_E2, P.pop[p].ihr2[a] * (1. - P.pop[p].eh_va1d2[a])) +
                          binomial(nVa2_E2, P.pop[p].ihr2[a] * (1  - P.pop[p].eh_va2d2[a])) +
                          binomial(nVa3_E2, P.pop[p].ihr2[a] * (1  - P.pop[p].eh_va3d2[a])) +
                          binomial(nVb1_E2, P.pop[p].ihr2[a] * (1  - P.pop[p].eh_vb1d2[a])) +
                          binomial(nVb2_E2, P.pop[p].ihr2[a] * (1  - P.pop[p].eh_vb2d2[a])) +
                          binomial(nVb3_E2, P.pop[p].ihr2[a] * (1  - P.pop[p].eh_vb3d2[a])) +
                          binomial(nS_E3,   P.pop[p].ihr3[a]) +
                          binomial(nVa1_E3, P.pop[p].ihr3[a] * (1. - P.pop[p].eh_va1d3[a])) +
                          binomial(nVa2_E3, P.pop[p].ihr3[a] * (1  - P.pop[p].eh_va2d3[a])) +
                          binomial(nVa3_E3, P.pop[p].ihr3[a] * (1  - P.pop[p].eh_va3d3[a])) +
                          binomial(nVb1_E3, P.pop[p].ihr3[a] * (1  - P.pop[p].eh_vb1d3[a])) +
                          binomial(nVb2_E3, P.pop[p].ihr3[a] * (1  - P.pop[p].eh_vb2d3[a])) +
                          binomial(nVb3_E3, P.pop[p].ihr3[a] * (1  - P.pop[p].eh_vb3d3[a]));
        double critical = binomial(nS_E,    P.pop[p].iir1[a]) +
                          binomial(nVa1_E,  P.pop[p].iir1[a] * (1. - P.pop[p].eh_va1d[a])) +
                          binomial(nVa2_E,  P.pop[p].iir1[a] * (1  - P.pop[p].eh_va2d[a])) +
                          binomial(nVa3_E,  P.pop[p].iir1[a] * (1  - P.pop[p].eh_va3d[a])) +
                          binomial(nVb1_E,  P.pop[p].iir1[a] * (1  - P.pop[p].eh_vb1d[a])) +
                          binomial(nVb2_E,  P.pop[p].iir1[a] * (1  - P.pop[p].eh_vb2d[a])) +
                          binomial(nVb3_E,  P.pop[p].iir1[a] * (1  - P.pop[p].eh_vb3d[a])) +
                          binomial(nS_E2,   P.pop[p].iir2[a]) +
                          binomial(nVa1_E2, P.pop[p].iir2[a] * (1. - P.pop[p].eh_va1d2[a])) +
                          binomial(nVa2_E2, P.pop[p].iir2[a] * (1  - P.pop[p].eh_va2d2[a])) +
                          binomial(nVa3_E2, P.pop[p].iir2[a] * (1  - P.pop[p].eh_va3d2[a])) +
                          binomial(nVb1_E2, P.pop[p].iir2[a] * (1  - P.pop[p].eh_vb1d2[a])) +
                          binomial(nVb2_E2, P.pop[p].iir2[a] * (1  - P.pop[p].eh_vb2d2[a])) +
                          binomial(nVb3_E2, P.pop[p].iir2[a] * (1  - P.pop[p].eh_vb3d2[a])) +
                          binomial(nS_E3,   P.pop[p].iir3[a]) +
                          binomial(nVa1_E3, P.pop[p].iir3[a] * (1. - P.pop[p].eh_va1d3[a])) +
                          binomial(nVa2_E3, P.pop[p].iir3[a] * (1  - P.pop[p].eh_va2d3[a])) +
                          binomial(nVa3_E3, P.pop[p].iir3[a] * (1  - P.pop[p].eh_va3d3[a])) +
                          binomial(nVb1_E3, P.pop[p].iir3[a] * (1  - P.pop[p].eh_vb1d3[a])) +
                          binomial(nVb2_E3, P.pop[p].iir3[a] * (1  - P.pop[p].eh_vb2d3[a])) +
                          binomial(nVb3_E3, P.pop[p].iir3[a] * (1  - P.pop[p].eh_vb3d3[a]));
        ...
        double died = to_death[a].Mature();
        double hosp_admissions = to_hosp[a].Mature();
        double icu_admissions = to_icu[a].Mature();
        ...
        double fatal_V1   = binomial(nVa1_E,  P.pop[p].ifr1[a] * (1. - P.pop[p].em_va1d [a])) +
                            binomial(nVb1_E,  P.pop[p].ifr1[a] * (1. - P.pop[p].em_vb1d [a])) +
                            binomial(nVa1_E2, P.pop[p].ifr2[a] * (1. - P.pop[p].em_va1d2[a])) +
                            binomial(nVb1_E2, P.pop[p].ifr2[a] * (1. - P.pop[p].em_vb1d2[a])) +
                            binomial(nVa1_E3, P.pop[p].ifr3[a] * (1. - P.pop[p].em_va1d3[a])) +
                            binomial(nVb1_E3, P.pop[p].ifr3[a] * (1. - P.pop[p].em_vb1d3[a]));
        double fatal_V2   = binomial(nVa2_E,  P.pop[p].ifr1[a] * (1. - P.pop[p].em_va2d [a])) +
                            binomial(nVb2_E,  P.pop[p].ifr1[a] * (1. - P.pop[p].em_vb2d [a])) +
                            binomial(nVa2_E2, P.pop[p].ifr2[a] * (1. - P.pop[p].em_va2d2[a])) +
                            binomial(nVb2_E2, P.pop[p].ifr2[a] * (1. - P.pop[p].em_vb2d2[a])) +
                            binomial(nVa2_E3, P.pop[p].ifr3[a] * (1. - P.pop[p].em_va2d3[a])) +
                            binomial(nVb2_E3, P.pop[p].ifr3[a] * (1. - P.pop[p].em_vb2d3[a]));
        double fatal_V3   = binomial(nVa3_E,  P.pop[p].ifr1[a] * (1. - P.pop[p].em_va3d [a])) +
                            binomial(nVb3_E,  P.pop[p].ifr1[a] * (1. - P.pop[p].em_vb3d [a])) +
                            binomial(nVa3_E2, P.pop[p].ifr2[a] * (1. - P.pop[p].em_va3d2[a])) +
                            binomial(nVb3_E2, P.pop[p].ifr2[a] * (1. - P.pop[p].em_vb3d2[a])) +
                            binomial(nVa3_E3, P.pop[p].ifr3[a] * (1. - P.pop[p].em_va3d3[a])) +
        ...
        double severe_V1  = binomial(nVa1_E,  P.pop[p].ihr1[a] * (1. - P.pop[p].eh_va1d [a])) +
                            binomial(nVb1_E,  P.pop[p].ihr1[a] * (1. - P.pop[p].eh_vb1d [a])) +
                            binomial(nVa1_E2, P.pop[p].ihr2[a] * (1. - P.pop[p].eh_va1d2[a])) +
                            binomial(nVb1_E2, P.pop[p].ihr2[a] * (1. - P.pop[p].eh_vb1d2[a])) +
                            binomial(nVa1_E3, P.pop[p].ihr3[a] * (1. - P.pop[p].eh_va1d3[a])) +
                            binomial(nVb1_E3, P.pop[p].ihr3[a] * (1. - P.pop[p].eh_vb1d3[a]));
        double severe_V2  = binomial(nVa2_E,  P.pop[p].ihr1[a] * (1. - P.pop[p].eh_va2d [a])) +
                            binomial(nVb2_E,  P.pop[p].ihr1[a] * (1. - P.pop[p].eh_vb2d [a])) +
                            binomial(nVa2_E2, P.pop[p].ihr2[a] * (1. - P.pop[p].eh_va2d2[a])) +
                            binomial(nVb2_E2, P.pop[p].ihr2[a] * (1. - P.pop[p].eh_vb2d2[a])) +
                            binomial(nVa2_E3, P.pop[p].ihr3[a] * (1. - P.pop[p].eh_va2d3[a])) +
                            binomial(nVb2_E3, P.pop[p].ihr3[a] * (1. - P.pop[p].eh_vb2d3[a]));
        double severe_V3  = binomial(nVa3_E,  P.pop[p].ihr1[a] * (1. - P.pop[p].eh_va3d [a])) +
                            binomial(nVb3_E,  P.pop[p].ihr1[a] * (1. - P.pop[p].eh_vb3d [a])) +
                            binomial(nVa3_E2, P.pop[p].ihr2[a] * (1. - P.pop[p].eh_va3d2[a])) +
                            binomial(nVb3_E2, P.pop[p].ihr2[a] * (1. - P.pop[p].eh_vb3d2[a])) +
                            binomial(nVa3_E3, P.pop[p].ihr3[a] * (1. - P.pop[p].eh_va3d3[a])) +
        ...
        double died_V1 = to_death_V1[a].Mature();
        double died_V2 = to_death_V2[a].Mature();
        double died_V3 = to_death_V3[a].Mature();
        double hosp_admissions_V1 = to_hosp_V1[a].Mature();
        double hosp_admissions_V2 = to_hosp_V2[a].Mature();
        double hosp_admissions_V3 = to_hosp_V3[a].Mature();
        ...
        L[a].Add(P, Rand, nVa1_L + nVa2_L + nVa3_L + nVb1_L + nVb2_L + nVb3_L, P.pop[p].dE);
        // If dE2 has been supplied, use that as latent period for strain 2, otherwise use dE.
        if (P.pop[p].dE2.weights.size() <= 1)
            L2[a].Add(P, Rand, nVa1_L2 + nVa2_L2 + nVa3_L2 + nVb1_L2 + nVb2_L2 + nVb3_L2, P.pop[p].dE);
        else
            L2[a].Add(P, Rand, nVa1_L2 + nVa2_L2 + nVa3_L2 + nVb1_L2 + nVb2_L2 + nVb3_L2, P.pop[p].dE2);
        // If dE3 has been supplied, use that as latent period for strain 3, otherwise use dE.
        if (P.pop[p].dE3.weights.size() <= 1)
            L3[a].Add(P, Rand, nVa1_L3 + nVa2_L3 + nVa3_L3 + nVb1_L3 + nVb2_L3 + nVb3_L3, P.pop[p].dE);
        else
            L3[a].Add(P, Rand, nVa1_L3 + nVa2_L3 + nVa3_L3 + nVb1_L3 + nVb2_L3 + nVb3_L3, P.pop[p].dE3);

        // Add new "skipped" (exposed to infection, but protected against transmitting by vaccine; go straight to R)
        R [a] += nVa1_R  + nVa2_R + nVa3_R + nVb1_R  + nVb2_R + nVb3_R;
        R2[a] += nVa1_R2 + nVa2_R2 + nVa3_R2 + nVb1_R2 + nVb2_R2 + nVb3_R2;
        R3[a] += nVa1_R3 + nVa2_R3 + nVa3_R3 + nVb1_R3 + nVb2_R3 + nVb3_R3;
        ...
        // Ip3 -> Is3
        double nIp3_Is3 = Ip3[a].Mature();
        Is3[a].Add(P, Rand, nIp3_Is3, (P.pop[p].dIs3.weights.size() > 1 ? P.pop[p].dIs3 : P.pop[p].dIs));

        // Is3 -> R3
        double nIs3_R3 = Is3[a].Mature();
        R3[a] += nIs3_R3;

        // Ia3 -> R3
        double nIa3_R3 = Ia3[a].Mature();
        R3[a] += nIa3_R3;
        ...
        for (auto& process : P.processes)
        {
            ...
            switch (process.source_id)
            {
                ...
                case src_newI:
                    n_entering = nE_Ipa; break; // I think we need to add nL_Ia here too
                case src_newIp:
                ...
                case src_newI2:
                    n_entering = nE2_Ipa2; break; // I think we need to add nL2_Ia2 here too
                case src_newIp2:
                ...
                case src_newI3:
                    n_entering = nE3_Ipa3; break; // I think we need to add nL3_Ia3 here too
                case src_newIp3:
