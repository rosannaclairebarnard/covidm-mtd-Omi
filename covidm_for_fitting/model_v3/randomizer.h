...
public:
    ...
    double TDist(double nu = 1.0, double x0 = 0.0, double scale = 1.0);
    ...
    void Sample(unsigned int N, std::vector<double>& p, std::vector<unsigned int>& i, bool stratified = false);
